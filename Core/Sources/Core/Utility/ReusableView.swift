...
extension UITableView {
    ...
    ///
    /// - Parameter cellType: cell class type
    public final func registerWithNib<T: UITableViewCell>(cellType: T.Type) {
    ...
    public final func registerHeader<T: UITableViewHeaderFooterView>(viewType: T.Type) {
    ...
    public final func registerHeaderWithNib<T: UITableViewHeaderFooterView>(viewType: T.Type) {
        let nib = UINib(nibName: T.nibName, bundle: nil)
    ...
    public final func dequeueReusableHeaderFooterView<T: UITableViewHeaderFooterView>(viewType: T.Type = T.self) -> T? {
...
extension UICollectionView {
    ...
    ///
    /// - Parameter cellType: cell class type
    public final func registerWithNib<T: UICollectionViewCell>(cellType: T.Type) {
        let nib = UINib(nibName: T.nibName, bundle: nil)
