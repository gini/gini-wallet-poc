...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let extraLightBlue = ColorAsset(name: "extraLightBlue")
    ...
    internal static let greenText = ColorAsset(name: "greenText")
  ...
  internal enum Images {
    ...
    internal static let backgroundGradient = ImageAsset(name: "backgroundGradient")
    internal static let check = ImageAsset(name: "check")
    internal static let close = ImageAsset(name: "close")
    internal static let faceID = ImageAsset(name: "faceID")
    internal static let giniQr = ImageAsset(name: "gini-qr")
    internal static let pools = ImageAsset(name: "pools")
