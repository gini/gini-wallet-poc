...
class TermsServicesViewController: UIViewController { 
    ...
    func setupView() {
        ...
        termsLabel.text = NSLocalizedString("terms", comment: "terms")
        
        acceptButton.setTitle(NSLocalizedString("accept_terms", comment: "accept_terms"), for: .normal)
        ...
        titleLabel.text = NSLocalizedString("terms_conditions", comment: "terms_conditions")
